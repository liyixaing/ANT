...
public class AESCipher {
    ...
    private static final String key = "pUAxbjGSiZQ1GIqU";
    ...
    public static String aesEncryptString(String content) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, UnsupportedEncodingException {
        ...
        String encodeStr = Base64.encodeToString(encryptedBytes, Base64.DEFAULT);

        if (encodeStr.getBytes()[encodeStr.length() - 1] == '\n') {
            return encodeStr.substring(0, encodeStr.length() - 1);
        }
    ...
    public static void test() throws UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
        String string = AESCipher.aesEncryptString("eda4f1a5d14108000ab8f42760aae4e36f5af6e961fad4865c8869f363c5fe50");

        Log.i("dasdasd", string);
        Log.i("dasdasd", AESCipher.aesDecryptString(string));
    }
