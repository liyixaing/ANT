...
//自定义的碎片分割器
public class AdaptiveUtlis extends View {
    private Context context;

    public AdaptiveUtlis(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public int GetCureentCheckedIndex()
    {
        return currentCheckedIndex;
    }

    public AdaptiveUtlis setContainer(int containerId) {
        this.containerId = containerId;
        return this;
    }

    public AdaptiveUtlis setTitleBeforeAndAfterColor(String beforeResCode, String AfterResCode) {//支持"#333333"这种形式
        titleColorBefore = Color.parseColor(beforeResCode);
        titleColorAfter = Color.parseColor(AfterResCode);
        return this;
    }

    public AdaptiveUtlis setTitleSize(int titleSizeInDp) {
        this.titleSizeInDp = titleSizeInDp;
        return this;
    }

    public AdaptiveUtlis setIconWidth(int iconWidth) {
        this.iconWidth = iconWidth;
        return this;
    }

    public AdaptiveUtlis setTitleIconMargin(int titleIconMargin) {
        this.titleIconMargin = titleIconMargin;
        return this;
    }

    public AdaptiveUtlis setIconHeight(int iconHeight) {
        this.iconHeight = iconHeight;
        return this;
    }

    public AdaptiveUtlis addItem(Class fragmentClass, String title, int iconResBefore, int iconResAfter) {
    ...
    public AdaptiveUtlis setFirstChecked(int firstCheckedIndex) {//从0开始
    ...
    {
        return fragmentList.get(currentCheckedIndex);
    }
